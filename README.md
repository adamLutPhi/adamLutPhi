...
_Before we could be *Computer Scientists*, we were Writers,
...
Feel at ease, from the steepness path of Failures_, as there is still time to:
...
Once inside, the `track of time1 gets _loose_-;  start feeling  so carried away, _(like riding the sea waves)_

celebration is yet to come,but continue the work, till: <br />
-(of course, don't forget to):<br />

_3.1.**Enjoy**_ admire _the simplicity_,of repeating`the Hobby` *(any nuance?)*
<br />

_3.2.**Flow**_  without forcing not any thoughts to it. Note you Are **Already Flowing** in it (& with it), 
...
-  been told  I'm always `rebuilding the wheel`! I am doing so that the `Spark of fire` in me can be rekindled, then, It would be transferred to *You* -in a Subsequence
...
- Stuck between **the Dichotomy** of this _Occam's Razor_: Sweetness of a _Coconut_, & the Bitterness of _Dark Chocolate_ (to be frank, I Wonder how *One day* the `inner-self` is helpful, yet it stays swinging in chaos , like a pendulum)

- **The Silver-Screen is an outdated**

Small things, is what I do, like trying the moistiness of `Tarte Tatin`, or the zestiness of  `Mee Goreng`
